...
void addrecords(); //========================== all of records function
...
void payment();//================================ all of records function
char get;
...
void addrecords()//================for save records
{
	FILE *f;
	char test;
	f=fopen("file.ojs","ab+");
...
void listrecords()//=============== visit for old records
{
	FILE *f;
	int i;
...
void searchrecords()
{
	...
	while(fread(&s,sizeof(s),1,f)==1)
	{
		...
		{	system("cls");
			printf(" Not found this phone number ");
		}
	}
	getch();
	fclose(f);
